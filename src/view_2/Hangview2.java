 ...
 * @author Khanh
 */
public class Hangview2 extends javax.swing.JPanel {
...
//        txtNgaytao.setDate(java.sql.Date.valueOf(ngaySuaLocalDate));
    ...
    private void initComponents() {
        ...
        tblHangsx = new javaswingdev.swing.table.Table();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(txtMaHang, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtTenHang, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        tblHangsx.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hãng ", "Tên hãng", "Ngày tạo", "Ngày sửa", "Mô tả", "Trạng thái "
            }
        ));
    ...
    private void tblHangsxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHangsxMouseClicked
        // TODO add your handling code here:
        if(tblHangsx.getSelectedRow() > -1){
            HangModel hangModel = hangController.timkiemHang().get(tblHangsx.getSelectedRow());
            txtMaHang.setText(hangModel.getMaHang());
            txtTenHang.setText(hangModel.getTenHang());
            txtMota.setText(hangModel.getMoTa());
            txtNgaytao.setDate(hangModel.getNgayTao());
...
//        }
    ...
    private void btnTimkiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimkiemActionPerformed
        ...
        if(txtTimkiem.getText().trim().equals("")){
               MsgBox.alert(this, "Mời nhập mã hãng ");
        }else{
           
            danhSachHang = hangController.timKiemHangTheoMa(txtTimkiem.getText());
            hienThiHang();
        }
    ...
    private javaswingdev.swing.table.Table tblHangsx;
